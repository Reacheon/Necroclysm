...
export namespace city
{
    ...
    inline constexpr std::array PRESET_CITIES = {
        ...
        PresetCity{ CityName::daegu,        "Daegu",        37027,  6496,   worldGrid::Terrain::Land },
        ...
        PresetCity{ CityName::jeju,         "Jeju",         36784,  6780,   worldGrid::Terrain::Land },
        PresetCity{ CityName::pyongyang,    "Pyongyang",    36693,  6117,   worldGrid::Terrain::Land },
        ...
        PresetCity{ CityName::beijing,      "Beijing",      35603,  6051,   worldGrid::Terrain::Land },
        ...
        PresetCity{ CityName::taibei,       "Taipei",       36180,  7797,   worldGrid::Terrain::Land },
        ...
        PresetCity{ CityName::istanbul,     "Istanbul",     25075,  5878,   worldGrid::Terrain::Land },
        ...
        PresetCity{ CityName::london,       "London",       21595,  4616,   worldGrid::Terrain::Land },
        PresetCity{ CityName::rome,         "Rome",         23103,  5777,   worldGrid::Terrain::Land },
        PresetCity{ CityName::oslo,         "Oslo",         22891,  3657,   worldGrid::Terrain::Subarctic },
        PresetCity{ CityName::stockholm,    "Stockholm",    23788,  3682,   worldGrid::Terrain::Subarctic },
        ...
        PresetCity{ CityName::oulu,         "Oulu",         24655,  2980,   worldGrid::Terrain::Land },
        PresetCity{ CityName::auckland,     "Auckland",     42576, 15229,   worldGrid::Terrain::Land },
        PresetCity{ CityName::sydney,       "Sydney",       39699, 14864,   worldGrid::Terrain::Land },
        PresetCity{ CityName::riyadh,       "Riyadh",       27200,  7835,   worldGrid::Terrain::Desert },
        PresetCity{ CityName::dubai,        "Dubai",        28209,  7815,   worldGrid::Terrain::Desert },
    };
