...
export constexpr std::array<std::array<int, 2>, 48> equipCoordLArm =
{ {
    {29, 23},{30, 24},{28, 21},{0,0},{0,0},{0,0},
...
export constexpr std::array<std::array<int, 2>, 48> equipCoordRArm =
{ {
        {16, 24},{17,23},{24,24},{0,0},{0,0},{0,0},
        {17, 23},{16,22},{23,25},{0,0},{0,0},{0,0},
        {17, 26},{18,27},{17,26},{0,0},{0,0},{0,0},
        {25, 28},{24,29},{27,30},{18,27},{15,22},{26,29},
...
export constexpr std::array<std::array<int, 2>, 48> equipCoordTwoHanded =
{ {
