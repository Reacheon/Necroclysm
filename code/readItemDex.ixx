...
namespace csvItem
{
    ...
    constexpr int flipEquipSpr = 74;
    constexpr int flipEquipPriority = 75;
    constexpr int leftWieldSpr = 76;
    constexpr int leftWieldPriority = 77;
    constexpr int rightWieldSpr = 78;
    constexpr int rightWieldPriority = 79;
    constexpr int tileConnectGroup = 80;
    constexpr int dirChangeItemCode = 81;
    constexpr int lightRange = 82;
    constexpr int lightIntensity = 83;
    constexpr int lightR = 84;
    constexpr int lightG = 85;
    constexpr int lightB = 86;
    constexpr int lightDelX = 87;
    constexpr int lightDelY = 88;
    constexpr int animeSize = 89;
    constexpr int animeFPS = 90;
    constexpr int randomPropSprSize = 91;
    constexpr int growthThreshold = 92;
    constexpr int molecularWeight = 93;
    constexpr int liqColorR = 94;
    constexpr int liqColorG = 95;
    constexpr int liqColorB = 96;
    constexpr int gasColorR = 97;
    constexpr int gasColorG = 98;
    constexpr int gasColorB = 99;
    constexpr int gasAlphaMax = 100;
    constexpr int propMaxHP = 101;
    constexpr int propRPierce = 102;
    constexpr int propRCut = 103;
    constexpr int propRBash = 104;
    constexpr int propDrawPriority = 105;
};
            ...
            if (str[i] == UNI::COMMA || str[i] == 10)//ASCII로 44(,)와 또는 라인피드(\n)와 같을 때
            {
                ...
                if (arrayCounter / (csvWidth) != 0)
                {
                    ...
                    case csvItem::flipEquipSpr:
                        errorBox(spr::spriteMapper.find(strFragment) == spr::spriteMapper.end(), L"이 아이템의 equip 이미지 파일이 spr::spriteMapper에 없음 : " + strFragment);
                        itemDex[arrayCounter / (csvWidth)-1].flipEquipSpr = spr::spriteMapper[strFragment.c_str()];

                        if (itemDex[arrayCounter / (csvWidth)-1].checkFlag(itemFlag::HAS_TOGGLE_SPRITE))
                        {
                            itemDex[arrayCounter / (csvWidth)-1].flipEquipSprToggleOn = spr::spriteMapper[(strFragment + L"On").c_str()];
                        }
                        break;
                    case csvItem::flipEquipPriority:
                        itemDex[arrayCounter / (csvWidth)-1].flipEquipPriority = wtoi(strFragment.c_str());
                        break;
                    ...
                    case csvItem::propDrawPriority:
                        itemDex[arrayCounter / (csvWidth)-1].propDrawPriority = wtoi(strFragment.c_str());
                        break;
                    default:
