...
namespace procGen
{
    namespace
    {
        ...
        constexpr int TILE_BASE_X = PATCH_X_MIN_LOCAL * PIXEL_PER_PATCH_LOCAL * TILES_PER_PIXEL; // -1,036,800
        constexpr int TILE_BASE_Y = PATCH_Y_MIN_LOCAL * PIXEL_PER_PATCH_LOCAL * TILES_PER_PIXEL; //   -518,400
