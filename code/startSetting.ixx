...
export void startSetting()
{
	...
	new Install(pX - 3, pY - 2, pZ, 291);//나무문 설치
	...
	new Install(pX - 4, pY - 5, pZ, 295);//책장
	new Install(pX - 2, pY - 5, pZ, 294);//침대

	new Install(pX - 4, pY - 3, pZ, 298);//상승계단
	...
	new Install(pX - 2, pY - 3, pZ, 299);//하강계단
	...
	//지하
	{
		...
		new Install(pX - 2, pY - 5, pZ - 1, 211);//전통등
		{
			...
			new Install(cursorX, cursorY, pZ - 1, itemVIPCode::railSwitchWS);//전환기

			int secondCursorX = cursorX+1;
			int secondCursorY = cursorY;
			for (int i = 0; i < 22; i++)
			{
				new Install(secondCursorX, secondCursorY, pZ - 1, itemVIPCode::railRL);//나무문 설치
				secondCursorX++;
			}
			...
			for (int i = 0; i < 26; i++)
			{
				new Install(cursorX, cursorY, pZ - 1, itemVIPCode::railTB);//나무문 설치
				cursorY++;
			}

			new Install(cursorX, cursorY, pZ - 1, itemVIPCode::railTL);//나무문 설치
			cursorX--;

			for (int i = 0; i < 11; i++)
			{
				new Install(cursorX, cursorY, pZ - 1, itemVIPCode::railRL);//나무문 설치
				cursorX--;
			}
			new Install(cursorX, cursorY, pZ - 1, itemVIPCode::railTR);//나무문 설치
			...
			//{
			//	new Install(endX + 3, targetY, pZ - 1, 303);//나무문 설치
			//}

			//new Install(endX + 3, endY - 20, pZ - 1, 317);//나무문 설치
			...
			//{
			//	new Install(targetX, endY - 20, pZ - 1, 303);//나무문 설치
			//}
	...
	new Install(pX + 2, pY - 1, pZ, 297);//표지판
	...
	new Install(pX + 1, pY - 2, pZ, 237);//나무 설치
	new Install(pX + 1 - 1, pY - 2, pZ, 235);//벚꽃낙엽 설치
	new Install(pX + 1, pY - 2 + 1, pZ, 235);//벚꽃낙엽 설치

	new Install(pX + 3, pY - 2, pZ, 239);//나무 설치

	new Install(pX + 5, pY - 1, pZ, 248);//나무 설치
	new Install(pX + 5, pY - 1 + 1, pZ, 235);//벚꽃낙엽 설치
	new Install(pX + 5 - 1, pY - 1, pZ, 235);//벚꽃낙엽 설치
	new Install(pX + 5 - 1, pY - 1 + 1, pZ, 235);//벚꽃낙엽 설치
	new Install(pX + 5 - 1, pY - 1 + 2, pZ, 235);//벚꽃낙엽 설치

	new Install(pX + 7, pY + 1, pZ, 237);//나무 설치
	new Install(pX + 7 - 1, pY + 1, pZ, 235);//벚꽃낙엽 설치

	new Install(pX + 4, pY - 5, pZ, 248);//나무 설치



	new Install(pX, pY - 20, pZ, 237);//벚꽃낙엽 설치
	...
	new Install(pX + -2, pY + 3, pZ, 270);//꽃 설치
	new Install(pX + -1, pY + 3, pZ, 265);//꽃 설치
	new Install(pX + 0, pY + 3, pZ, 266);//꽃 설치
	new Install(pX + 1, pY + 3, pZ, 267);//꽃 설치

	new Install(pX + -2, pY + 4, pZ, 271);//꽃 설치
	new Install(pX + -1, pY + 4, pZ, 268);//꽃 설치
	new Install(pX + 0, pY + 4, pZ, 269);//꽃 설치
	new Install(pX + 1, pY + 4, pZ, 270);//꽃 설치

	new Install(pX, pY - 1, pZ, 118);//볼라드 등 설치
