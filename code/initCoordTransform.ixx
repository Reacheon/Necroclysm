...
export void initCoordTransform()
{
    ...
    {
        for (int y = -1 - i; y >= -MAX_VEHICLE_SIZE / 2; y--) xShiftRight(dir16::dir1, y);
    ...
    for (int i = 0; i <= MAX_VEHICLE_SIZE / 2 - 1; i++)
    {
        for (int y = -1 - i; y >= -MAX_VEHICLE_SIZE / 2; y--) xShiftLeft(dir16::dir3, y);
    ...
    for (int i = 0; i <= MAX_VEHICLE_SIZE / 2 - 1; i++)
    {
        for (int y = -1 - i; y >= -MAX_VEHICLE_SIZE / 2; y--) xShiftRight(dir16::dir5, y);
    ...
    for (int i = 0; i <= MAX_VEHICLE_SIZE / 2 - 1; i++)
    {
        for (int y = -1 - i; y >= -MAX_VEHICLE_SIZE / 2; y--) xShiftLeft(dir16::dir7, y);
