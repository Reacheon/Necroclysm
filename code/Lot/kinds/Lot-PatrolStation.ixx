module;
export module Lot:PatrolStation;

import std;
import :base;

//순찰서 Lot 뼈대 — footprint/회전만 정의. build() 후속 작성.
export class PatrolStation final : public Lot
{
public:
...
export inline const PatrolStation patrolStation;
