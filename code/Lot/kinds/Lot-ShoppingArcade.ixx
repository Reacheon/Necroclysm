module;
export module Lot:ShoppingArcade;

import std;
import :base;

//상가 Lot 뼈대 — footprint/회전만 정의. build() 후속 작성.
export class ShoppingArcade final : public Lot
{
public:
...
export inline const ShoppingArcade shoppingArcade;
