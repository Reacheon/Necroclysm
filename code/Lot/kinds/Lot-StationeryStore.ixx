module;
export module Lot:StationeryStore;

import std;
import :base;

//문구점 Lot 뼈대 — footprint/회전만 정의. build() 후속 작성.
export class StationeryStore final : public Lot
{
public:
...
export inline const StationeryStore stationeryStore;
