module;
export module Lot:AnimalHospital;

import std;
import :base;

//동물병원 Lot 뼈대 — footprint/회전만 정의. build() 후속 작성.
export class AnimalHospital final : public Lot
{
public:
...
export inline const AnimalHospital animalHospital;
